...
const nodes={}; for(const n of wf.nodes) nodes[n.id]={status:"pending",retryCount:0,worktree:null,branch:null,threadId:null,requestId:null,attemptId:null,active:false,startedAt:null,finishedAt:null};
const state={version:2,taskId,workflow:wf.name,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),nodes,requests:{},locks:{}};
