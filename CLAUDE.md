...
This project is indexed by GitNexus as **codex-harness-engineering-template** (1200 symbols, 1687 relationships, 26 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
